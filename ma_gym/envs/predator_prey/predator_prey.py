...
class PredatorPrey(gym.Env):
    ...
    def __init__(self, grid_shape=(20, 20), n_agents=2, n_preys=1, prey_move_probs=(0.175, 0.175, 0.175, 0.175, 0.3),
                 full_observable=False, penalty=-0.5, step_cost=-0.01, prey_capture_reward=5, max_steps=100,
                 agent_view_mask=(19, 19)):
    ...
    def __next_pos(self, curr_pos, move):
        moves = {
            0: [curr_pos[0] + 1, curr_pos[1]], # down
            1: [curr_pos[0], curr_pos[1] - 1], # left
            2: [curr_pos[0] - 1, curr_pos[1]], # up
            3: [curr_pos[0], curr_pos[1] + 1], # right
            4: [curr_pos[0], curr_pos[1]] #none
        }
        next_pos = moves[move]
    ...
    def __get_neighbour_coordinates(self, pos):
        ...
        if self.is_valid([pos[0] + 2, pos[1]]):
            neighbours.append([pos[0] + 2, pos[1]])
        if self.is_valid([pos[0] - 2, pos[1]]):
            neighbours.append([pos[0] - 2, pos[1]])
        if self.is_valid([pos[0], pos[1] + 2]):
            neighbours.append([pos[0], pos[1] + 2])
        if self.is_valid([pos[0], pos[1] - 2]):
            neighbours.append([pos[0], pos[1] - 2])
        return neighbours
